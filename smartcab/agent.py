...
class LearningAgent(Agent):
	...
	def reset(self, destination=None, testing=False):
		...
		# Basic linear decay function
		#self.epsilon = self.epsilon - 0.05

		# epsilon = 1/t^2
		#self.trial += 1
		#self.epsilon = 1.0/math.pow(self.trial,2)
		...
		# epsilon  = 1/ e^(X * t)
		#self.epsilon = 1.0/ math.exp(0.02* self.trial)
		#self.trial += 1
	...
	def build_state(self):
		...
		state = tuple([waypoint, inputs['light'],inputs['oncoming'],inputs['right'],inputs['left']])
	...
	def choose_action(self, state):
		...
		if not self.learning :
			...
			if random.random() < self.epsilon:
				...
				actions = [k for k,v in self.Q[state].iteritems() if v == maxQvalue]
